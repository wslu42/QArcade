...
`qilin.p8` in this directory is the **original upstream Qilin cartridge** copied from:

- repository: `wslu42/qilin`
- branch: `main`
- path: `qilin.p8`

It is retained only as a historical and asset-bearing reference.
