...
function _update()
 ...
 if sup then
	 ...
	 p.l.x ,p.l.y, p.r.x ,p.r.y
	  =pb.x ,  pb.y,pb.x+40,   pb.y
	 p.l.sp = pb.sp + 1
	 p.r.sp = pb.sp + 1
	else
	 p.l            = {}
	 p.l.x ,p.l.y  = pb.x ,  pb.y
	 p.l.sp        = pb.sp
 end
...

